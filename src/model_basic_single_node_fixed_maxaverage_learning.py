...
from custom_class.custom_learning_average_stopping_maxdata import CustomAutoencoder
from custom_class.custom_learning_average_stopping_maxdata import DualConditionEarlyStopping
